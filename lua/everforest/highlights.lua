...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    CmpItemKindField = syntax_entry(palette.fg, palette.fg, { styles.bold }),
    CmpItemKindProperty = syntax_entry(palette.fg, palette.fg, { styles.bold }),
    CmpItemKindEvent = syntax_entry(palette.fg, palette.fg, { styles.bold }),
    CmpItemKindText = syntax_entry(palette.green, palette.green, { styles.bold }),
    CmpItemKindEnum = syntax_entry(palette.green, palette.green, { styles.bold }),
    CmpItemKindKeyword = syntax_entry(palette.green, palette.green, { styles.bold }),
    CmpItemKindConstant = syntax_entry(palette.yellow, palette.yellow, { styles.bold }),
    CmpItemKindConstructor = syntax_entry(palette.yellow, palette.yellow, { styles.bold }),
    CmpItemKindReference = syntax_entry(palette.yellow, palette.yellow, { styles.bold }),
    CmpItemKindFunction = syntax_entry(palette.blue, palette.blue, { styles.bold }),
    CmpItemKindStruct = syntax_entry(palette.blue, palette.blue, { styles.bold }),
    CmpItemKindClass = syntax_entry(palette.blue, palette.blue, { styles.bold }),
    CmpItemKindModule = syntax_entry(palette.blue, palette.blue, { styles.bold }),
    CmpItemKindOperator = syntax_entry(palette.blue, palette.blue, { styles.bold }),
    CmpItemKindVariable = syntax_entry(palette.grey1, palette.grey1, { styles.bold }),
    CmpItemKindFile = syntax_entry(palette.grey1, palette.grey1, { styles.bold }),
    CmpItemKindUnit = syntax_entry(palette.purple, palette.purple, { styles.bold }),
    CmpItemKindSnippet = syntax_entry(palette.purple, palette.purple, { styles.bold }),
    CmpItemKindFolder = syntax_entry(palette.purple, palette.purple, { styles.bold }),
    CmpItemKindMethod = syntax_entry(palette.aqua, palette.aqua, { styles.bold }),
    CmpItemKindValue = syntax_entry(palette.aqua, palette.aqua, { styles.bold }),
    CmpItemKindEnumMember = syntax_entry(palette.aqua, palette.aqua, { styles.bold }),
    CmpItemKindInterface = syntax_entry(palette.statusline1, palette.statusline1, { styles.bold }),
    CmpItemKindColor = syntax_entry(palette.statusline1, palette.statusline1, { styles.bold }),
    CmpItemKindTypeParameter = syntax_entry(palette.statusline1, palette.statusline1, { styles.bold }),
