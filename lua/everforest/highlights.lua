local highlights = {}
local darken_color = require("everforest.util").darken_color
...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    CmpItemKindField = syntax_entry(palette.fg, darken_color(palette.fg, 0.1), { styles.bold }),
    CmpItemKindProperty = syntax_entry(palette.fg, darken_color(palette.fg, 0.1), { styles.bold }),
    CmpItemKindEvent = syntax_entry(palette.fg, darken_color(palette.fg, 0.1), { styles.bold }),
    CmpItemKindText = syntax_entry(palette.green, darken_color(palette.green, 0.1), { styles.bold }),
    CmpItemKindEnum = syntax_entry(palette.green, darken_color(palette.green, 0.1), { styles.bold }),
    CmpItemKindKeyword = syntax_entry(palette.green, darken_color(palette.green, 0.1), { styles.bold }),
    CmpItemKindConstant = syntax_entry(palette.yellow, darken_color(palette.yellow, 0.1), { styles.bold }),
    CmpItemKindConstructor = syntax_entry(palette.yellow, darken_color(palette.yellow, 0.1), { styles.bold }),
    CmpItemKindReference = syntax_entry(palette.yellow, darken_color(palette.yellow, 0.1), { styles.bold }),
    CmpItemKindFunction = syntax_entry(palette.blue, darken_color(palette.blue, 0.1), { styles.bold }),
    CmpItemKindStruct = syntax_entry(palette.blue, darken_color(palette.blue, 0.1), { styles.bold }),
    CmpItemKindClass = syntax_entry(palette.blue, darken_color(palette.blue, 0.1), { styles.bold }),
    CmpItemKindModule = syntax_entry(palette.blue, darken_color(palette.blue, 0.1), { styles.bold }),
    CmpItemKindOperator = syntax_entry(palette.blue, darken_color(palette.blue, 0.1), { styles.bold }),
    CmpItemKindVariable = syntax_entry(palette.gray, darken_color(palette.gray, 0.1), { styles.bold }),
    CmpItemKindFile = syntax_entry(palette.gray, darken_color(palette.gray, 0.1), { styles.bold }),
    CmpItemKindUnit = syntax_entry(palette.purple, darken_color(palette.purple, 0.1), { styles.bold }),
    CmpItemKindSnippet = syntax_entry(palette.purple, darken_color(palette.purple, 0.1), { styles.bold }),
    CmpItemKindFolder = syntax_entry(palette.purple, darken_color(palette.purple, 0.1), { styles.bold }),
    CmpItemKindMethod = syntax_entry(palette.aqua, darken_color(palette.aqua, 0.1), { styles.bold }),
    CmpItemKindValue = syntax_entry(palette.aqua, darken_color(palette.aqua, 0.1), { styles.bold }),
    CmpItemKindEnumMember = syntax_entry(palette.aqua, darken_color(palette.aqua, 0.1), { styles.bold }),
    CmpItemKindInterface = syntax_entry(palette.teal, darken_color(palette.teal, 0.1), { styles.bold }),
    CmpItemKindColor = syntax_entry(palette.teal, darken_color(palette.teal, 0.1), { styles.bold }),
    CmpItemKindTypeParameter = syntax_entry(palette.teal, darken_color(palette.teal, 0.1), { styles.bold }),
