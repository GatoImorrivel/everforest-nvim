...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    CmpItemKindVariable = syntax_entry(palette.gray, palette.gray, { styles.bold }),
    CmpItemKindFile = syntax_entry(palette.gray, palette.gray, { styles.bold }),
    ...
    CmpItemKindInterface = syntax_entry(palette.teal, palette.teal, { styles.bold }),
    CmpItemKindColor = syntax_entry(palette.teal, palette.teal, { styles.bold }),
    CmpItemKindTypeParameter = syntax_entry(palette.teal, palette.teal, { styles.bold }),
