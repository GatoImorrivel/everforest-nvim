...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    CmpItemKindField = syntax_entry(palette.fg, M.darken(palette.fg, 0.1), { styles.bold }),
    CmpItemKindProperty = syntax_entry(palette.fg, M.darken(palette.fg, 0.1), { styles.bold }),
    CmpItemKindEvent = syntax_entry(palette.fg, M.darken(palette.fg, 0.1), { styles.bold }),
    CmpItemKindText = syntax_entry(palette.green, M.darken(palette.green, 0.1), { styles.bold }),
    CmpItemKindEnum = syntax_entry(palette.green, M.darken(palette.green, 0.1), { styles.bold }),
    CmpItemKindKeyword = syntax_entry(palette.green, M.darken(palette.green, 0.1), { styles.bold }),
    CmpItemKindConstant = syntax_entry(palette.yellow, M.darken(palette.yellow, 0.1), { styles.bold }),
    CmpItemKindConstructor = syntax_entry(palette.yellow, M.darken(palette.yellow, 0.1), { styles.bold }),
    CmpItemKindReference = syntax_entry(palette.yellow, M.darken(palette.yellow, 0.1), { styles.bold }),
    CmpItemKindFunction = syntax_entry(palette.blue, M.darken(palette.blue, 0.1), { styles.bold }),
    CmpItemKindStruct = syntax_entry(palette.blue, M.darken(palette.blue, 0.1), { styles.bold }),
    CmpItemKindClass = syntax_entry(palette.blue, M.darken(palette.blue, 0.1), { styles.bold }),
    CmpItemKindModule = syntax_entry(palette.blue, M.darken(palette.blue, 0.1), { styles.bold }),
    CmpItemKindOperator = syntax_entry(palette.blue, M.darken(palette.blue, 0.1), { styles.bold }),
    CmpItemKindVariable = syntax_entry(palette.gray, M.darken(palette.gray, 0.1), { styles.bold }),
    CmpItemKindFile = syntax_entry(palette.gray, M.darken(palette.gray, 0.1), { styles.bold }),
    CmpItemKindUnit = syntax_entry(palette.purple, M.darken(palette.purple, 0.1), { styles.bold }),
    CmpItemKindSnippet = syntax_entry(palette.purple, M.darken(palette.purple, 0.1), { styles.bold }),
    CmpItemKindFolder = syntax_entry(palette.purple, M.darken(palette.purple, 0.1), { styles.bold }),
    CmpItemKindMethod = syntax_entry(palette.aqua, M.darken(palette.aqua, 0.1), { styles.bold }),
    CmpItemKindValue = syntax_entry(palette.aqua, M.darken(palette.aqua, 0.1), { styles.bold }),
    CmpItemKindEnumMember = syntax_entry(palette.aqua, M.darken(palette.aqua, 0.1), { styles.bold }),
